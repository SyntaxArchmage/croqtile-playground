...
### Content
- 45 tutorials (ch01–ch45) with "Try it" inline code blocks
- 160 challenges (c01–c160) with auto-verification, progress badges, and "in progress" status
- 30 example programs
...
- 962 unit/component tests across 44 suites
