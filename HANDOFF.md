...
- `npm run lint` ✅
- `npm run build` ✅
- Coverage: 99.95% stmts, 99.2% branches, 100% functions, 100% lines
...
- 200 challenges (c01–c200) with auto-verification, progress badges, and "in progress" status
- 60 example programs
...
- Coverage: 99.95% statements, 99.2% branches, 100% functions, 100% lines
