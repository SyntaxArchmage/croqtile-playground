...
export const challenge125: Challenge = {
  id: "c125",
  title: "Matrix Flatten",
  difficulty: "easy",
  description: `Flatten a **2×3** matrix into a 1D array in row-major order.
...
`,
  ...
  hint: "Each (i, j) maps to flat[i * 3 + j] = matrix[i, j].",
};
